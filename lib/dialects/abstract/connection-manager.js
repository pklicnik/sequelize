...
class ConnectionManager {
  ...
  _loadDialectModule(moduleName) {
    try {
      console.log("_loadDialectModule");
      console.log(this.sequelize.config.dialectModulePath);
      console.log(this.sequelize.config.dialectModule);
      try {
        const d = require("sqlite3");
        console.log(d);
      } catch (err) {
        console.log("ERROR ON REQEUIRE");
      }
